...
- [CoTrader](https://github.com/get-cotrader/cotrader-mcp) - AI-powered stock screener for 11,000+ US stocks. Screen using natural language queries and detect chart patterns including support/resistance, trendlines, channels, double bottoms, and head & shoulders.
